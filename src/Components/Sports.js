...
export default function Sports()
{
    ...
    React.useEffect(()=>{
        ...
        axios.get(`https://api.nytimes.com/svc/topstories/v2/sports.json?api-key=${process.env.REACT_APP_API_KEY}`)
  ...
  <div className="col-50 border-bottom ">
      <img src={allArticles[index].multimedia[0].url} className="img-res" />
